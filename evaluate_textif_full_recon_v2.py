...
def _resolve_ir_vis_dirs(data_path: str):
    ...
    # Try common split sub-directories (test, val)
...
def prepare_image_list(data_path: str, sample: int, seed: int) -> List[str]:
    ...
    # If both dirs contain only sub-folders (e.g. train/test), pick "test"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate Text_IF_Recon v2 (FFBlock replaces feature_fusion)")
    parser.add_argument("--data_path", type=str, default="data/IVT_test",
                        help="Path containing ir/+vis/ or infrared/+visible/ (with optional train/test split)")
    parser.add_argument("--weights_path", type=str,
                        default="experiments/TextIF_full_recon_2_20260506-213402/weights/checkpoint.pth",
                        help="Text_IF_Recon v2 model weight path")
    parser.add_argument("--output_dir", type=str, default="results/textif_full_recon_v2_eval",
